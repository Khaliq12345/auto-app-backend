                        ...
                        <div class="flex-1 space-y-2">
                            <div class="flex justify-between items-start">
                                ...
                                <div class="text-right">
                                    ...
                                    <UBadge
                                        :color="
                                            getDealBadgeColor(item.deal_type)
                                        "
                                        variant="soft"
                                        size="xs"
                                    >
                            ...
                            >
                                ...
                                <div>
                                    <span class="text-gray-600">Gearbox:</span>
                                    <p class="font-medium">
...
function getDealBadgeColor(
    ...
    | "secondary"
    | "warning" {
    if (dealType?.includes("VERY_GOOD")) return "success";
    if (dealType?.includes("GOOD")) return "primary";
    if (dealType?.includes("BAD")) return "error";
    return "neutral";
}
